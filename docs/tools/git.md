...
After entering for the first time GitHub username and password,
this creates a `.git-credentials` file with this contents:

```
https://avillasenorh:personal_access_token@github.com
```
